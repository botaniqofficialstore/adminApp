...
class _MapScreenState extends ConsumerState<MapScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final userScreenNotifier = ref.watch(SellerMainScreenGlobalStateProvider.notifier);
          ...
          children: [
            ...
            if (_isMoving)...{
              ...
              SizedBox(
                width: double.infinity,
                child: Padding(
                  padding: EdgeInsets.only(left: 15.dp, right: 15.dp, top: 15.dp, bottom: 10.dp),
                  child: Column(
            ...
            if (_currentZoom >= _minZoomLevel && !_isMoving && _selectedAddress.isNotEmpty)...{
              CupertinoButton(
                padding: EdgeInsets.only(
                    bottom: 20.dp, left: 15.dp, right: 15.dp),
                onPressed: () {
              ...
              if(!_isMoving)
                Padding(
                  padding: EdgeInsets.only(left: 15.dp, right: 15.dp, bottom: 20.dp),
                  child: Container(
