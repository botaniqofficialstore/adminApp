...
import 'ConfirmedOrderScreenState.dart';

class ConfirmedOrderScreen extends ConsumerStatefulWidget {
  const ConfirmedOrderScreen({super.key});

  @override
  ConfirmedOrderScreenState createState() => ConfirmedOrderScreenState();
}

class ConfirmedOrderScreenState extends ConsumerState<ConfirmedOrderScreen>
    with SingleTickerProviderStateMixin {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

  @override
  Widget build(BuildContext context) {
    var newOrderScreenState = ref.watch(ConfirmedOrderScreenStateProvider);
