...
class DeliveryScreenState extends ConsumerState<DeliveryScreen>
  ...
  Widget build(BuildContext context) {
    var contractScreenState = ref.watch(DeliveryScreenStateProvider);
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Divider(color: Colors.black45, height: 1.5.dp,),
                                            ),
  ...
  Widget statusChip(BuildContext context, String text) {
    return CupertinoButton(
      onPressed: (){},
      padding: EdgeInsets.zero,
      child: Container(
        padding: EdgeInsets.symmetric(horizontal: 6.dp, vertical: 6.dp),
        decoration: BoxDecoration(
          color: objConstantColor.yellow,
          borderRadius: BorderRadius.circular(5.dp),
        ),
